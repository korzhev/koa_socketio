...
describe('Server', () => {
  ...
  describe('GET /file.ext', () => {
    ...
    context('When exists', () => {
      ...
      it('returns 200 & the file', function* () {
        let fixtureContent = fs.readFileSync(`${fixturesRoot}/small.png`);

        const response = yield request.get(`${host}/small.png`);
  ...
  describe('GET /nested/path', () => {
    it('returns 400', function* () {
      const response = yield request.get(`${host}/nested/path`);
  ...
  describe('POST /file.ext', () => {
      ...
      context('When too big', () => {
        ...
        it('return 413 and no file appears', function* () {
          ...
          try {
            ...
            if (err.message === 'write EPIPE') return this.skip();
    ...
    context('otherwise with zero file size', () => {
      ...
      it('returns 200 & file is uploaded', function* () {
        const req = request.post(`${host}/small.png`);
