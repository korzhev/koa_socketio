...
module.exports = function*(options) {
  ...
  message.html  = pug.renderFile(path.join(config.template.root, 'email', options.template), locals);
  ...
  let transportResponse = yield transport.sendMail(message);

  let letter = yield Letter.create({
    message,
    transportResponse,
